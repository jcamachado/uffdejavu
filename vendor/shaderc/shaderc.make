...
RESCOMP = windres
TARGETDIR = bin/shaderc
TARGET = $(TARGETDIR)/libshaderc.a
INCLUDES += -Ilibshaderc/include -Ilibshaderc_util/include -Ithird_party/glslang -Ithird_party/spirv-tools/include -Ithird_party/spirv-headers/include
FORCE_INCLUDE +=
...
OBJDIR = bin-int/shaderc/Release
...
GENERATED += $(OBJDIR)/shaderc.o
OBJECTS += $(OBJDIR)/shaderc.o
...
$(OBJDIR)/shaderc.o: libshaderc/src/shaderc.cc
	@echo "$(notdir $<)"
